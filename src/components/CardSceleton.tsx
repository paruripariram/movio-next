export default function CardSkeleton() {
    return (
        <div className="relative flex max-w-92.5 w-full aspect-2/3 overflow-hidden rounded-2xl sm:rounded-4xl bg-zinc-900 p-2.5 sm:p-5 flex-col justify-end">
            <div className="absolute inset-0 -translate-x-full bg-linear-to-r from-transparent via-zinc-800/60 to-transparent animate-shimmer pointer-events-none z-10" />
